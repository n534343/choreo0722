...
const UUID = process.env.UUID || '4f13f380-7c7b-4382-8fe6-6bd62cae3993'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo11.annie33.dpdns.org';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiOTdjOTJkNmVlODkzNTgzZWM4NDhiZDZhZDFlZDg1MWUiLCJ0IjoiZGE5ODJiM2EtNmJlYS00ZTRlLTkxOGMtMzZlNDhjMzNhNWI2IiwicyI6Ik1UWmhaVGxtWW1JdFlqRTFaaTAwT0RobUxUZzJZMkV0TW1FNFpUSTRNbVl6Tm1ZMSJ9';
const CFIP = process.env.CFIP || 'japan.com';
const NAME = process.env.NAME || 'Choreo0722';
